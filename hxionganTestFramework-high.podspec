...
s.source           = { :http => "https://sdk-release.qnsdk.com/hxionganTestFramework-high-v1.0.2.zip" }
...
s.subspec "High" do |ss1|
    ss1.vendored_framework = "Pod/High/hxionganTestFramework.framework"
end
